...
export default function Home() {
  ...
  const handleFindRoute = async () => {
    ...
    if (!fromStop || !toStop) {
      setError("Please select both your starting point and destination.");
      return;
    }
    ...
    >
      ...
      {!selectedCity ? (
        ...
        >
          ...
          >
            ...
            >
              Tell us where you are and where you want
              to go. Raasta helps you understand which
              bus route to take and how to reach your
              destination.
            </Typography>
      ...
      >
        ...
        <DialogContent sx={{ pb: 3 }}>
          ...
          >
            Choose your city to find available bus routes.
          </Typography>
